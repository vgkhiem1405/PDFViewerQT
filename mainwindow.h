...
private slots:
    ...
    void on_actionTo_Word_triggered();

    void on_actionTo_Excel_triggered();

    void on_actionTo_PP_triggered();
...
private:
    ...
    bool convertPdfToExcel();
    bool convertPowerPointToPDF();
    bool selectInputFile();
};
